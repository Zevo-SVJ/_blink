 ...
 *   0,35  ce qui relie     — whoosh de raccord
 *   0,30  ce qui court     — rouleau du compteur, présent sous une autre couche
 *
 * Un raccord doit s'entendre sans couvrir ce qu'il relie : c'est pour ça que le
 * whoosh est 3 dB sous l'impact, et non l'inverse.
 *
...
export const SFX = {
	...
	/** Raccord rapide, balayage, passage d'un instrument. */
	whooshFast: {file: 'sfx/whoosh_fast.mp3', volume: 0.35},
